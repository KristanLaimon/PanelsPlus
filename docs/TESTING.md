...
| Transitions and controller behavior | `panelviewer_navtransition_spec.lua`, `viewer_controller_rotation_spec.lua`, `viewer_controller_more_config_spec.lua`, `spread_rotation_spec.lua`, `foldjoin_spec.lua` |
