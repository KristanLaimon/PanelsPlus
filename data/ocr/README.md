...
requires at least 95% normalized word matches. It includes training samples;
it is not a measurement on unseen books or physical readers. The latest exact
scores are in [`OCR_REPORT.md`](../../OCR_REPORT.md).
Complete OCR runs save their best scores in the book's
