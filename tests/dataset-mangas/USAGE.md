    ...
    "pages": [
      {
        ...
        "phrase": [
          { "x": 80, "y": 90, "w": 180, "h": 32, "phrase_id": 1, "text": "Hello there" },
          { "x": 80, "y": 126, "w": 150, "h": 32, "phrase_id": 1, "text": "Hello there" }
        ],
        "word": [
...
word, a phrase has no text, or a word has no text or overlapping phrase. Older files containing only `frame` remain valid.
...
advances to the next Phrase ID before prompting for text. The value persists locally in
the gitignored root file `manga-annotator.config.json`. Hold `Alt` while finishing a
distant rectangle to keep the current Phrase ID for that one fragment.
